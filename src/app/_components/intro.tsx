...
export function Intro() {
  ...
  // Fallback title
  const displayTitle = title || "Welcome to My World";
  ...
  return (
    <section className="relative mb-16 md:mb-20 mt-8">
      ...
      <div className="relative">
        ...
        <div className="mb-8">
          <h1 className="text-8xl md:text-8xl lg:text-8xl font-extrabold tracking-tighter leading-tight mb-4 pb-4">
            {isLoading ? (
              <span className="block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">
                Welcome to My World
                <span className="inline-block ml-2 w-3 h-3 bg-blue-600 rounded-full animate-pulse"></span>
              </span>
            ) : (
              <span className="block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">
                {displayTitle}
        ...
        <div className="max-w-2xl mb-8">
          <p className="text-xl md:text-2xl text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            Exploring ideas, sharing experiences, and documenting the journey.
          </p>
