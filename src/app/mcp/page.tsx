...
const TOOLS = [
  ...
  {
    title: "SQL Audit Explorer",
    description: "A specialized tool for analyzing Postgres access patterns and security audit logs.",
    type: "Local / Stdio",
    url: "github.com/sunando94/mcp-postgres-audit",
    icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
